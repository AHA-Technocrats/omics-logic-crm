...
use AHATechnocrats\Admin\Http\Middleware\Locale;
use AHATechnocrats\Admin\Http\Middleware\SanitizeUrl;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerFacades(): void
    {
        ...
        $loader->alias('Bouncer', \AHATechnocrats\Admin\Facades\Bouncer::class);
