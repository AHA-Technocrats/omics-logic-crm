...
return [
    ...
    'users' => [
        ...
        'login' => [
            ...
            'email' => 'Email',
            'email-placeholder' => 'omicslogic@example.com',
        ...
        'layouts' => [
            ...
            'header' => [
                'mega-search' => [
                    ...
                    'explore-all-campaigns' => 'Explore all Campaigns',
                    'explore-all-leads' => 'Explore all Leads',
                    'explore-all-contacts' => 'Explore all Contacts',
                    'explore-all-organizations' => 'Explore all Organizations',
                    ...
                    'explore-all-matching-campaigns' => 'Explore all campaigns matching ":query" (:count)',
                    ...
                    'explore-all-matching-organizations' => 'Explore all organizations matching ":query" (:count)',
        ...
        'persons' => [
            ...
            'view' => [
                ...
                'tabs' => [
                    ...
                    'portal-timeline' => 'Portal Timeline',
                    'campaigns' => 'Interested In Campaigns',
                ],
                'portal' => [
                    'profile-title' => 'Profile On Portal',
                    ...
                    'fields' => [
                        ...
                        'country' => 'Country',
                        'phone' => 'Phone',
                        'join-date' => 'Joined Portal',
                        'programs' => 'Programs Joined',
                    ],
                ],
                'campaigns' => [
                    'empty' => 'No campaign interests recorded yet.',
                    'interests' => 'interests',
                    'inquiry' => 'Inquiry',
                    'no-description' => 'No inquiry description for this lead.',
                    'view-lead' => 'View full lead',
                    'unknown-campaign' => 'Unspecified campaign',
                ],
                'activities' => [
                    'index' => [
                        'all' => 'All',
    ...
    'settings' => [
        ...
        'campaign-categories' => [
            'index' => [
                ...
                'create-success' => 'Campaign category created successfully.',
                'delete-failed' => 'Campaign category can not be deleted.',
                'delete-success' => 'Campaign category deleted successfully.',
                'update-success' => 'Campaign category updated successfully.',
                'name-exists' => 'A campaign category with this name already exists.',
                'delete-failed-associated-campaigns' => 'Campaign category cannot be deleted because it is associated with existing campaigns. Please reassign or update those campaigns before deletion.',
                'datagrid' => [
                    'delete' => 'Delete',
                    'edit' => 'Edit',
                    'id' => 'ID',
        ...
        'webforms' => [
            ...
            'form' => [
                'is-active' => 'Active',
                'send-submitter-email' => 'Send confirmation email to submitter',
                'email-template' => 'Confirmation Email Template',
                'select-email-template' => 'Select email template',
                'email-template-help' => 'Use placeholders like {{name}}, {{email}}, {{organization}}, {{program}}, and any custom field code.',
                'customization' => 'Customization',
                'apply' => 'Apply',
                'customization-saved' => 'Customization saved',
                'customization-applied' => 'Customization applied to this form',
                'interested-in-campaign' => 'Interested in Program',
                'interested-in-campaign-field' => 'Show on form',
                'field-show' => 'Show (Required)',
                'field-hide' => 'Hide',
                'field-none' => 'None (Hidden)',
                ...
                'preview-after-save' => 'Save the form first to preview it here.',
                'yes' => 'Yes',
                'no' => 'No',
            ],
            'responses' => [
                ...
                'heading' => 'Responses — :title',
                'subtitle' => ':count total responses',
                'edit-form' => 'Edit Form',
            ...
            'create' => [
                ...
                'step-form' => 'Form',
                'step-lead-email' => 'Lead & email',
                'step-after-submit' => 'After submit',
            ...
            'edit' => [
                ...
                'person' => 'Person',
                'preview' => 'Preview',
                'public-url' => 'Full Form URL',
                'public-url-help' => 'Full form address (long link).',
                'short-url' => 'Short URL',
                'short-url-help' => 'Copy and share this short link (e.g. /f/abc12345).',
                'redirect-to-url' => 'Redirect To URL',
                'redirect-url' => 'Redirect URL',
                'thank-you-page' => 'Thank You Page',
                'thank-you-page-info' => 'Design the confirmation page shown after a successful submission (like Google Forms).',
        ...
        'users' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'module-access-info' => 'Access is based on the selected role. Data visibility applies to owner-scoped modules.',
                    'access' => 'Access',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'source-info' => 'Optional. The selected source is applied to every imported record (updates the lead source).',
                    'source-none' => 'Keep source from file / none',
                    'assigned-sales-rep' => 'Assigned Sales Rep',
                    'assigned-sales-rep-info' => 'Optional. Assigns this sales owner to imported contacts/leads when the file has no owner column.',
                    'assigned-sales-rep-none' => 'Keep owner from file / auto-assign',
    ...
    'leads' => [
        ...
        'create' => [
            ...
            'campaigns' => 'Campaigns',
            'campaigns-info' => 'Information About the Campaigns',
        ],
        'edit' => [
            'title' => 'Edit Lead',
            'save-btn' => 'Save',
        ...
        'view' => [
            ...
            'campaigns' => [
                ...
                'empty-info' => 'No Campaigns Found for this Lead',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'settings' => [
                    ...
                    'contacts' => [
                        'title' => 'Contact Configurations',
                        'info' => 'Configure default values used when creating contacts.',
                        'default-lifecycle-stage' => 'Default Lifecycle Stage',
                        'default-lifecycle-stage-info' => 'The lifecycle stage pre-selected when creating a new person.',
                    ],
                ],
            ],
            'email' => [
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Everything you need to get the most out of AHATechnocrats Admin — hosting, support and professional services, plus extensions and developer documentation.',
            'contact-us' => 'Contact us',
            'view-all' => 'View all',
            'still-need-help-title' => 'Still need a hand?',
            'still-need-help-description' => 'Talk to the AHATechnocrats team about hosting, custom development or anything else.',

            'services' => [
                'title' => 'Services & Resources',
                'cloud-hosting' => [
                    'title' => 'Cloud Hosting',
                    'description' => 'Cost-effective, managed cloud hosting — try and launch AHATechnocrats on the cloud in minutes, fully optimised and scalable.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensions',
                    'description' => 'Browse official and community add-ons to extend AHATechnocrats with new connectors, channels and features.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'API Docs',
                    'description' => 'Full REST API reference with endpoints, authentication and examples to integrate AHATechnocrats with your stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Connect with thousands of other AHATechnocrats users and developers to share tips and solve problems.',
    ...
    'layouts' => [
        ...
        'campaign-categories' => 'Campaign Categories',
        'campaign-categories-info' => 'Add, edit or delete campaign categories from CRM',
