        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label>
                            @lang('admin::app.settings.data-transfer.imports.create.source')
                        </x-admin::form.control-group.label>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            id="source_id"
                            :value="old('source_id')"
                            :label="trans('admin::app.settings.data-transfer.imports.create.source')"
                        >
                            <option value="">@lang('admin::app.settings.data-transfer.imports.create.source-none')</option>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            @lang('admin::app.settings.data-transfer.imports.create.source-info')
                        </p>
                    ...
                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label>
                            @lang('admin::app.settings.data-transfer.imports.create.assigned-sales-rep')
                        </x-admin::form.control-group.label>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            id="user_id"
                            :value="old('user_id')"
                            :label="trans('admin::app.settings.data-transfer.imports.create.assigned-sales-rep')"
                        >
                            <option value="">@lang('admin::app.settings.data-transfer.imports.create.assigned-sales-rep-none')</option>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            @lang('admin::app.settings.data-transfer.imports.create.assigned-sales-rep-info')
                        </p>
