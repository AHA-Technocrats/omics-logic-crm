@php($placeholders = app('\AHATechnocrats\Automation\Helpers\Entity')->getEmailTemplatePlaceholders())
                    ...
                    <x-admin::accordion>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                >
                                    @foreach (app('\AHATechnocrats\Automation\Helpers\Entity')->getEvents() as $item)
