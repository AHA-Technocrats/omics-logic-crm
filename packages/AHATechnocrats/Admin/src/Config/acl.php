...
return [
    [
        ...
        'key' => 'persons.create.quick-create',
        'name' => 'admin::app.acl.quick_add',
        'route' => ['admin.contacts.persons.create', 'admin.contacts.persons.store'],
        'sort' => 1,
    ], [
        ...
        'key' => 'organizations.create.quick-create',
        'name' => 'admin::app.acl.quick_add',
        'route' => ['admin.contacts.organizations.create', 'admin.contacts.organizations.store'],
        'sort' => 1,
    ], [
        ...
        'name' => 'admin::app.acl.create',
        'route' => ['admin.campaigns.create', 'admin.campaigns.store'],
        'sort' => 1,
    ], [
        'key' => 'campaigns.create.quick-create',
        'name' => 'admin::app.acl.quick_add',
        'route' => ['admin.campaigns.create', 'admin.campaigns.store'],
        'sort' => 1,
    ], [
        'key' => 'campaigns.edit',
        'name' => 'admin::app.acl.edit',
        'route' => ['admin.campaigns.edit', 'admin.campaigns.update'],
        'sort' => 2,
    ], [
        'key' => 'campaigns.delete',
        'name' => 'admin::app.acl.delete',
        'route' => ['admin.campaigns.delete', 'admin.campaigns.mass_delete'],
        'sort' => 3,
    ], [
        'key' => 'campaigns.view',
        'name' => 'admin::app.acl.view',
        'route' => 'admin.campaigns.view',
        'sort' => 3,
    ], [
        'key' => 'merge_review',
        ...
        'key' => 'merge_review.resolve',
        'name' => 'omicslogic::app.acl.resolve',
        'route' => 'admin.omics.merge.resolve',
        'sort' => 1,
    ], [
        'key' => 'segments',
        ...
        'key' => 'reports.export',
        'name' => 'omicslogic::app.acl.export',
        'route' => 'admin.omics.reports.export',
        'sort' => 1,
    ], [
        'key' => 'imports',
        ...
        'key' => 'connectors.edit',
        'name' => 'admin::app.acl.edit',
        'route' => ['admin.omics.connectors.edit', 'admin.omics.connectors.update'],
        'sort' => 1,
    ], [
        'key' => 'connectors.sync',
        'name' => 'omicslogic::app.acl.sync',
        'route' => 'admin.omics.connectors.sync',
        'sort' => 2,
    ], [
        'key' => 'audit_log',
        ...
        'key' => 'audit_log.undo',
        'name' => 'omicslogic::app.acl.undo',
        'route' => 'admin.omics.audit.undo',
        'sort' => 1,
    ], [
        'key' => 'settings',
