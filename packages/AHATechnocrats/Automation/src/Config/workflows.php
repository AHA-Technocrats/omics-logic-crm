...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name' => 'Leads',
            'class' => 'AHATechnocrats\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name' => 'Activities',
            'class' => 'AHATechnocrats\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name' => 'Persons',
            'class' => 'AHATechnocrats\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name' => 'Quotes',
            'class' => 'AHATechnocrats\Automation\Helpers\Entity\Quote',
            'events' => [
                [
