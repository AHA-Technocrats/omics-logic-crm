...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'ahatechnocrats-crm:install
     ...
     * @var string
     */
    protected $description = 'ahatechnocrats installer.';
    ...
    /**
     * Install and configure ahatechnocrats.
     */
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for AHATechnocrats kickstart...');
        $this->info(app(AHATechnocratsDatabaseSeeder::class)->run([
    ...
    protected function askForApplicationDetails()
    {
        $this->updateEnvVariable(
            ...
            env('APP_NAME', 'AHATechnocrats CRM')
        );
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'AHATechnocrats is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use AHATechnocrats.');
