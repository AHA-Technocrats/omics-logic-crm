...
namespace AHATechnocrats\Installer\Events;
...
class ComposerEvents
{
    ...
    /**
     * Build the AHATechnocrats Cloud Hosting promotional box for the console output.
     *
     * @return string
     */
    public static function cloudHostingBox()
    {
        ...
        $lines = [
            ...
            ['', 'fg=#ffffff'],
            ['Skip the server setup — run AHATechnocrats on fast, secure,', 'fg=#ffffff'],
