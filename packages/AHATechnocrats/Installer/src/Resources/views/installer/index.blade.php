                ...
                <div class="flex flex-col justify-center">
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <img
                                src="{{ vite()->asset('images/ahatechnocrats-logo.svg', 'installer') }}"
                                alt="@lang('installer::app.installer.index.ahatechnocrats-logo')"
                            >
                        ...
                        <p class="mb-6 w-full place-self-end text-left">
                            ...
                            <span>@lang('installer::app.installer.index.ahatechnocrats-info')</span>
                    ...
                    <div class="flex h-[484px] flex-col justify-center gap-4 overflow-y-auto px-7 py-4">
                        <div class="flex flex-col gap-4">
                            <p class="text-lg font-bold text-gray-800">
                                @lang('installer::app.installer.index.installation-processing.ahatechnocrats')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <p class="text-sm text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.ahatechnocrats-info')
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        type="text"
                                        name="app_name"
                                        ::value="envData.app_name ?? 'AHATechnocrats'"
                                        rules="required"
                                        :label="trans('installer::app.installer.index.environment-configuration.application-name')"
                                        :placeholder="trans('installer::app.installer.index.environment-configuration.ahatechnocrats')"
                                    />
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.ahatechnocrats')"
                                    />
                            ...
                            const stepActions = {
                                envDatabase: () => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["AHATechnocrats currently supports MySQL only."] });
                                    }
                                },
