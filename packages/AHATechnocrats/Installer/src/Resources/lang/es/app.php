    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'ahatechnocrats' => 'Instalación de AHATechnocrats',
                'ahatechnocrats-info' => 'Creando las tablas de la base de datos, esto puede tardar unos momentos',
                'title' => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel' => 'Panel de Administración',
                'ahatechnocrats-forums' => 'Foro de AHATechnocrats',
                'customer-panel' => 'Panel de Clientes',
                'explore-ahatechnocrats-extensions' => 'Explorar Extensiones de AHATechnocrats',
                'title' => 'Instalación Completada',
                'title-info' => 'AHATechnocrats se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'Crear tabla de base de datos',
                'install' => 'Instalación',
                'install-info' => 'AHATechnocrats Para la Instalación',
            ...
            'start' => [
                ...
                'title' => 'Instalación de AHATechnocrats',
                'welcome-title' => 'Bienvenido a AHATechnocrats',
            ],
            ...
            'back' => 'Atrás',
            'ahatechnocrats' => 'AHATechnocrats',
            'ahatechnocrats-info' => 'un Proyecto Comunitario de',
            'ahatechnocrats-logo' => 'Logotipo de AHATechnocrats',
            'continue' => 'Continuar',
            'installation-description' => 'La instalación de AHATechnocrats generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación de AHATechnocrats.',
            ...
            'title' => 'Instalador de AHATechnocrats',
            'webkul' => 'Webkul',
        ],
    ],
];
