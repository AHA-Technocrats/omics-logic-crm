    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'ahatechnocrats' => 'تثبيت AHATechnocrats',
                'ahatechnocrats-info' => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title' => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel' => 'لوحة المشرف',
                'ahatechnocrats-forums' => 'منتديات AHATechnocrats',
                'customer-panel' => 'لوحة العميل',
                'explore-ahatechnocrats-extensions' => 'استكشاف امتدادات AHATechnocrats',
                'title' => 'اكتمال التثبيت',
                'title-info' => 'تم تثبيت AHATechnocrats بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'إنشاء جدول قاعدة البيانات',
                'install' => 'التثبيت',
                'install-info' => 'AHATechnocrats للتثبيت',
            ...
            'start' => [
                ...
                'title' => 'تثبيت AHATechnocrats الخاص بك',
                'welcome-title' => 'مرحبًا بك في AHATechnocrats',
            ],
            ...
            'back' => 'رجوع',
            'ahatechnocrats' => 'AHATechnocrats',
            'ahatechnocrats-info' => 'مشروع مجتمعي من قبل',
            'ahatechnocrats-logo' => 'شعار AHATechnocrats',
            'continue' => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت AHATechnocrats عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت ahatechnocrats',
            'installation-info' => 'نحن سعداء برؤيتك هنا!',
            'installation-title' => 'مرحبًا بك في التثبيت',
            'installation-wizard' => 'لغة معالج التثبيت',
            'title' => 'مثبت AHATechnocrats',
            'webkul' => 'Webkul',
        ],
    ],
];
