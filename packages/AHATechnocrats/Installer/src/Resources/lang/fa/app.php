    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'ahatechnocrats' => 'نصب کرایین',
                'ahatechnocrats-info' => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'ahatechnocrats-forums' => 'انجمن کرایین',
                'customer-panel' => 'پنل مشتری',
                'explore-ahatechnocrats-extensions' => 'کاوش افزونه‌های کرایین',
                'title' => 'نصب کامل شد',
            ...
            'back' => 'بازگشت',
            'ahatechnocrats' => 'کرایین',
            'ahatechnocrats-info' => 'یک پروژه اجتماعی توسط',
            'ahatechnocrats-logo' => 'لوگوی کرایین',
            'continue' => 'ادامه',
