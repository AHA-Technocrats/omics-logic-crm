    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'ahatechnocrats' => 'Instalação do AHATechnocrats',
                'ahatechnocrats-info' => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'ahatechnocrats-forums' => 'Fórum AHATechnocrats',
                'customer-panel' => 'Painel do Cliente',
                'explore-ahatechnocrats-extensions' => 'Explorar Extensões AHATechnocrats',
                'title' => 'Instalação Concluída',
                'title-info' => 'AHATechnocrats foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title' => 'Instalação do AHATechnocrats',
                'welcome-title' => 'Bem-vindo ao AHATechnocrats',
            ],
            ...
            'back' => 'Voltar',
            'ahatechnocrats' => 'AHATechnocrats',
            'ahatechnocrats-info' => 'um projeto comunitário de',
            'ahatechnocrats-logo' => 'Logotipo AHATechnocrats',
            'continue' => 'Continuar',
            'installation-description' => 'A instalação do AHATechnocrats geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do AHATechnocrats',
            ...
            'title' => 'Instalador do AHATechnocrats',
            'webkul' => 'Webkul',
        ],
    ],
];
