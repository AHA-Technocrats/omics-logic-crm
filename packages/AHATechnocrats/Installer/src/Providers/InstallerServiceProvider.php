...
class InstallerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router): void
    {
        ...
        Event::listen('ahatechnocrats.installed', 'AHATechnocrats\Installer\Listeners\Installer@installed');
        ...
        $this->app['router']->get('cache/{filename}', [
            'uses' => 'AHATechnocrats\Installer\Http\Controllers\ImageCacheController@getImage',
            'as' => 'image_cache',
        ])->where(['filename' => '[ \w\\.\\/\\-\\@\(\)\=]+']);
    }
